from . import session, anime as _anime, character as _char, client as _client, forum as _forum, manga as _manga, \
    staff as _staff, studio as _studio, review as _review, user as _user
...
class Anilist:
    ...
    class Anime(API):
        ...
        def browse(self,
                   ...
                   airing_data=None,
                   full_page=None):
            return _anime.browse(self._con, page, year, season, _type, status, genres, genres_exclude, sort,
                                 airing_data, full_page)
    ...
    class User(API):
        ...
        def create_anime_entry(self, id,
                               ...
                               custom_lists=",,,,",
                               hidden_default=0):
            return _user.create_anime_entry(self._con, id, list_status, score, score_raw, episodes_watched, rewatched,
        ...
        def create_manga_entry(self, id,
                               ...
                               custom_lists=",,,,",
                               hidden_default=0):
            return _user.create_manga_entry(self._con, id, list_status, score, score_raw, volumes_read, chapters_read,
                                            reread, notes, advanced_rating_scores, custom_lists, hidden_default)
